...
def tokenize_function(examples):
    ...
    # ?use the tokenizer's built-in data collator for MLM masking in Trainer? - study
    return outputs

#tokenize the dataset
tokenized_dataset = dataset.map(tokenize_function, batched=True, remove_columns=["text"])

#split train/validation (which is optional)
...
# ?data collator will handle masking tokens dynamically? - study
